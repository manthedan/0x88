...
def main() -> None:
    ap = argparse.ArgumentParser(
        description="Build expanded SquareFormer feature memmap from compact cache dir."
    )
    ap.add_argument(
        "--input-cache",
        required=True,
        help="compact_square_tokens_v1 / compact_position_eval_cache_v1 / compact_action_value_cache_v1 dir",
    )
