...
- treats argv entries as queued UCI commands in `wasm32` builds, enabling one-shot browser searches.
...
Local Node smoke from the patched WASI artifact succeeded for:
...
and returned `bestmove g1h3` from the v20.0.0-dev/v106 network build.
