...
| Centipawn | `bt4-auto`, `bt4-ort`, `bt4-custom` | Mixed; ORT baseline, custom WebGPU explicit | Centipawn SquareFormer evaluator/search path | BT4 Anneal Muon Best | Small research-family assets relative to LC0 BT4 | Legacy `tiny` deep-links and URL overrides are accepted for compatibility. |
