...
| Tiny Leela | `bt4-auto`, `bt4-ort`, `bt4-custom` | Mixed; ORT baseline, custom WebGPU explicit | Tiny SquareFormer evaluator/search path | BT4 Anneal Muon Best | Small research-family assets relative to LC0 BT4 | Legacy-named family kept active for compatibility; rename separately after choosing a replacement name. |
