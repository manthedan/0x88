...
- `npm run lc0:browser-wgsl-smokes -- --no-server --only encoder0-ffn,encoder0-block --timeout 25000`
  ...
  - `ENCODER0_BLOCK_BENCH_DONE`, max absolute error about `3.58e-6` before tiled QKV/output/FFN matmuls and about `3.34e-6` after them.
