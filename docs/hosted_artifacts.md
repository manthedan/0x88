...
| 0x88 Neural / Tiny Leela BT4 | `bt4_soap_rem_c19000_final` (`best-bt4`) | `/models/bt4_soap_rem_c19000_final.onnx`; metadata `/models/bt4_soap_rem_c19000_final.meta.json`; provenance `docs/model_provenance/bt4_soap_rem_c19000_final.md` | Tracked/deployable via Git LFS | First 0x88 Neural public candidate. BT4/SquareFormer + ThreatGraph TG1 trained from LC0 public data with Stockfish labels; not ChessBench, TCEC, or generic human-game corpus. |
