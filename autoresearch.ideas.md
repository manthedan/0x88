...
- Do not revisit adjacent current-best toggles without a new implementation shape: TVM outproj+project, TVM QKV+project, split-FFN TVM dense1-only/dense2-only, GPU/WASM legal priors, JS/WGSL input backends, and 32/128/256-column smolgen-project tile sizes all lost fast screens against the WASM-input/JS-legal 64-column project winner.
