...
function parseArgs(argv) {
  ...
  for (let i = 0; i < argv.length; i++) {
    ...
    else if (arg === '--legal-priors-backends' || arg === '--legal-priors-backend')
      args.legalPriorsBackends = parseList(next(), (value) => value, 'legal-priors-backends');
