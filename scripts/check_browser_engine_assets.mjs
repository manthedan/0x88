...
const ASSET_GROUPS = [
  {
    ...
    assets: ['/models/lc0/BT4-1024x15x32h-swa-6147500.batch1.f16.onnx'],
  },
  {
    family: 'reckless',
    label: 'Reckless WASI/browser variants',
    status: 'experimental-selectable',
    command: 'npm run reckless:build-production && npm run reckless:build-browser-api-simd-external && npm run reckless:build-lite-wasi',
  ...
  },
  {
    ...
    assets: ['/viridithas/viridithas.wasm', '/viridithas/viridithas-simd128.wasm'],
  },
  {
    family: 'berserk',
    ...
    assets: ['/berserk/berserk-emscripten.js', '/berserk/berserk-emscripten.wasm', '/berserk/berserk-emscripten.data'],
  },
  {
    family: 'plentychess',
