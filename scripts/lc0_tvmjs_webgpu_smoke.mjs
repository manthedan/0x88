...
function parseArgs(argv) {
  const args = { batch: 8, fixtures: true, fixtureOffset: 0, fixtureCount: undefined, tensorCache: false, fensFile: '', ortCompare: 'none', ortEp: 'webgpu', searchVisits: 0, searchFixtures: 2, searchRepeats: 1, stockfishScoreDepth: undefined, stockfishScoreMs: undefined, host: DEFAULT_HOST, port: DEFAULT_PORT, timeoutMs: DEFAULT_TIMEOUT_MS, agentBrowser: DEFAULT_AGENT_BROWSER, noServer: false };
