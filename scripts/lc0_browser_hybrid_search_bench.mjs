...
function parseArgs(argv) {
  ...
  if (!['hand', 'tvm-packed-f16', 'mixed-tvm-ffn'].includes(args.encoderKernel)) throw new Error(`Invalid --encoder-kernel: ${args.encoderKernel}`);
