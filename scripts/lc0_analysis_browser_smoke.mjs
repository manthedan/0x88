...
const REQUIRED_FAMILIES = ['lc0', 'centipawn', 'sf', 'reckless', 'viridithas', 'berserk', 'plentychess', 'stormphrax'];
const REQUIRED_RUNTIME_TOKENS = ['Lc0 BT4:', 'Centipawn:', 'Reckless:', 'Viridithas:', 'Berserk:', 'PlentyChess:', 'Stormphrax:'];
