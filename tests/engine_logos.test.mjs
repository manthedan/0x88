...
test('engine logo helper maps displayed engine names to bundled logo families', () => {
  ...
  assert.equal(engineLogoFamilyForName('Tiny Leela'), undefined);
  assert.equal(engineLogoFamilyForName('PlentyChess'), undefined);
});
...
test('engine logo helper maps selector families to bundled assets', () => {
  ...
  assert.equal(engineLogoFamilyForEngineFamily('tiny'), undefined);
  assert.equal(engineLogoFamilyForEngineFamily('plentychess'), undefined);
});
