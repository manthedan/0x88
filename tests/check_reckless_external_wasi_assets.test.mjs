...
test('Reckless external WASI prototype has explicit build, release, publish, and manifest coverage', async () => {
  ...
  assert.doesNotMatch(packageJson.scripts['reckless:release-manifest'], /--skip-compression-estimates/);
  assert.match(packageJson.scripts['reckless:release-manifest'], /--brotli-quality 4/);
